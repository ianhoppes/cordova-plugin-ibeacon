...
public interface IBeaconServiceNotifier {
     ...
     */
    void monitoringDidFailForRegion(Region region, Exception exception);

    /*
     * notified when a ranging listener fails to start or the listener fails
     */
    void rangingBeaconsDidFailForRegion(Region region, Exception exception);

    /*
     * Most likely when Bluetooth aerial is switched on or off
     */
    void didChangeAuthorizationStatus(String status);
}
